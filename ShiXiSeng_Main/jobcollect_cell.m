...
#import "jobcollect_cell.h"

@interface jobcollect_cell ()<UIGestureRecognizerDelegate>
...
@implementation jobcollect_cell
...
{
    [self.delegate contextMenuCellDidSelectMoreOption:(id)self];
}
