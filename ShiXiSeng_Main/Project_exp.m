...
#import "Project_exp.h"

@interface Project_exp ()
@property (nonatomic, strong) CNPPopupController *popupController;
@end



@implementation Project_exp
-(void)didSelect:(NSString *)timestring{
    [_chosetime1 setTitle:timestring forState:UIControlStateNormal];
}
-(void)didSelect1:(NSString *)timestring{
    [_chosetim2 setTitle:timestring forState:UIControlStateNormal];
}
-(IBAction)press1:(id)sender{
    __flag_ = 2;
    [_chosetime1 setTitle:@"请选择时间" forState:UIControlStateNormal];
     [self showPopupWithStyle:CNPPopupStyleCentered];
}
-(IBAction)press2:(id)sender{
    __flag_ = 0;
    [_chosetim2 setTitle:@"请选择时间" forState:UIControlStateNormal];
     [self showPopupWithStyle:CNPPopupStyleCentered];
}
