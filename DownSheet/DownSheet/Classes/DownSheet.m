...
-(void)animeData{
    ...
    [UIView animateWithDuration:.25 animations:^{
        ...
        [UIView animateWithDuration:.25 animations:^{
            ...
            [view_second setFrame:CGRectMake(view_second.frame.origin.x, ScreenHeight-view_second.frame.size.height, view_second.frame.size.width, view_second.frame.size.height)];
            [view_third setFrame:CGRectMake(view_third.frame.origin.x,ScreenHeight-view_third.frame.size.height,view_third.frame.size.width, view_third.frame.size.height)];
            }];
...
//        NSString *fullpath_3=[[NSBundle mainBundle]pathForResource:@"job_third(3).plist" ofType:nil];
//        NSString *fullpath_4=[[NSBundle mainBundle]pathForResource:@"job_third(4).plist" ofType:nil];
//        NSString *fullpath_5=[[NSBundle mainBundle]pathForResource:@"job_third(5).plist" ofType:nil];
//        NSString *fullpath_6=[[NSBundle mainBundle]pathForResource:@"job_third(6).plist" ofType:nil];
//        NSString *fullpath_7=[[NSBundle mainBundle]pathForResource:@"job_third(7).plist" ofType:nil];
//        NSString *fullpath_8=[[NSBundle mainBundle]pathForResource:@"job_third(8).plist" ofType:nil];
//        NSString *fullpath_9=[[NSBundle mainBundle]pathForResource:@"job_third(9).plist" ofType:nil];
//        NSString *fullpath_10=[[NSBundle mainBundle]pathForResource:@"job_third(10).plist" ofType:nil];
